...
public class WeatherApiControllerTest {
	...
	public void weather() throws Exception {
		...
		setWeatherEntry(weather, 22.33, 800, "01d", Instant.ofEpochSecond(1234));
		...
		this.mvc.perform(get("/api/weather/now/uk/london"))
				...
				.andExpect(jsonPath("$.temperature", is(22.33)))
	...
	public void weatherForecast() throws Exception {
		...
		forecast.getEntries().add(createWeatherEntry(12.3, 600, "02d", Instant.ofEpochSecond(1234)));
		forecast.getEntries().add(createWeatherEntry(21.3, 800, "01d", Instant.ofEpochSecond(5678)));
		...
		this.mvc.perform(get("/api/weather/weekly/be/brussels"))
				...
				.andExpect(jsonPath("$.entries[0].temperature", is(12.3)))
				.andExpect(jsonPath("$.entries[1].temperature", is(21.3)));
